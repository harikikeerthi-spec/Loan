  ...
  async saveOnboardingData(data: any, userId?: string) {
    try {
      ...
      const updateData: any = {
        ...
        motherName: nonEmpty(personal.motherName) || nonEmpty(data.motherName) || user?.motherName || null,
        ...
        family: (data.familyDetails || data.family) ? (typeof (data.familyDetails || data.family) === 'string' ? (data.familyDetails || data.family) : JSON.stringify(data.familyDetails || data.family)) : (user?.family || null),
