...
async function fixShanmukaApp() {
  console.log('Resetting applicationNumber to null for Shanmuka Sai Kalneedi (ID: 24377891-b436-4c6c-9e0b-6ecd37235c7d)...');
  const { data, error } = await supabase
    .from('LoanApplication')
    .update({ applicationNumber: null })
    .eq('id', '24377891-b436-4c6c-9e0b-6ecd37235c7d')
    .select('id, applicationNumber, firstName, lastName, status');
