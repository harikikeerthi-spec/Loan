                ...
                <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-6">
                    <div>
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <span className="text-[10px] font-black uppercase tracking-[0.3em] text-rose-600">Module 02 • Decisions</span>
                        </div>
                                    ...
                                    >
                                        ...
                                        <div className="border-t border-gray-50 pt-4 flex justify-between items-end">
                                            <div>
                                                ...
                                                <span className="text-lg font-black text-gray-900 font-display">₹{(app.amount / 100000).toFixed(1)}L</span>
                                            </div>
