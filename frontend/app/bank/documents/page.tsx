                ...
                <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-6">
                    <div>
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <span className="text-[10px] font-black uppercase tracking-[0.3em] text-purple-600">Module 03 • Documents</span>
                        </div>
                                                            ...
                                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                                {docs.map((doc: any) => {
                                                                    ...
                                                                    return (
                                                                        <div 
                                                                            key={doc.id}
                                                                            className="p-4 bg-white border border-gray-100 rounded-xl flex items-center justify-between shadow-sm"
                                                                        >
                                                                            <div className="flex items-center gap-3">
                                                                                <span className="material-symbols-outlined text-gray-400">description</span>
                                                                                <div>
                                                                                    <span className="text-xs font-bold text-gray-800 uppercase tracking-tight block truncate max-w-[200px]">
                                                                                        {doc.docType}
                                                                                    </span>
